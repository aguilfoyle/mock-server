...
var GetCodeBooks = {
    name: 'GetCodeBooks',
    mockRoute: '\/api\/v1\/code-books', //a regex for the route, ex. '\/api\/steps\/.*\/users' is a valid route
...
var DeleteCodebook = {
    name: 'DeleteCodebook',
    mockRoute: '\/api\/v1\/code-books\/\\d+$', //a regex for the route, ex. '\/api\/steps\/.*\/users' is a valid route
